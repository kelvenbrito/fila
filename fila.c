...
int main (void)
{
    ...
    do{
            printf("Veja as opções abaixo e digite o numero correspondente a opção\n\n");
            printf("1. Retirar Senha Para Obter Benção Material\n\n");
            printf("2. Retirar Senha Para Obter Benção Espiritual\n\n");
            printf("3. Conceder Benção Material\n\n");
            printf("4. Conceder Benção Espiritual\n\n");
            printf("5. Mostrar Lista Para Benção Material\n\n");
            printf("6. Mostrar Lista Para Benção Espiritua\n\n");
